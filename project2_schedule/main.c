...
int main(int argc, char *argv[]) {
	...
	{	
		//fill code here -- generate genSchedInfo structure by genSchedInfo function 함수로 구조체 만들라잖아  
		void* sched_genSchedInfo;
		schedInfo = sched_genSchedInfo;//(char* name, char* place, int type, int month, int day)
